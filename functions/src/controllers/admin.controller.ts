...
import { updateTeacherStatus, updateUserSubscription, deleteUserAccount, createAdmin } from "../models/admin.model";
...
export const createAdminUser = async (req: Request, res: Response) => {
    try {
        ...
        // Use model layer for database operation
        const adminUid = await createAdmin(email, password);
